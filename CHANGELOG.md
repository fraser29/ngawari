...
## [0.1.21] - 2026-05-26
### Changed
- Updated `readVTKFile` to use the lower case extension of the file to determine the type of file to read.
...
- Function to get the direction vectors of a vtkStructuredGrid or similar. (`getVtsDirectionVectors`)

## [0.1.18] - 2026-03-03
### Added
- Function to resample a vtkStructuredGrid or similar to an image, aligned to the best axis-aligned orientation of the vtsObj. (`filterResampleToImage_BestAligned`)
- Correction in `getVtsResolution` to handle 2D data.
